...
namespace recipe_3_08
{
   ...
   void execute()
   {
...

      {
         ...
         auto txt1 = funclib::fold_left([](std::string const & s, std::string const & n) {return s + n; }, texts, ""s);
         // txt1 = "hello world!"
         auto txt2 = funclib::fold_right([](std::string const & s, std::string const & n) {return s + n; }, texts, ""s);
         // txt2 = "!world hello"
